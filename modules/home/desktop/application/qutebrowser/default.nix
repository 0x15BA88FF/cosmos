...
{
  options.modules.desktop.applications.qutebrowser.enable = lib.mkEnableOption "Enable qutebrowser";

  config = lib.mkIf config.modules.desktop.applications.qutebrowser.enable {
